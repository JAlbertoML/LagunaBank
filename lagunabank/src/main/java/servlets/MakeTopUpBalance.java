...
public class MakeTopUpBalance extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public MakeTopUpBalance() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String message = MovementsBs.makeTopUpBalance(client, request.getParameter("amountTxt"));
		if(message != null) {
